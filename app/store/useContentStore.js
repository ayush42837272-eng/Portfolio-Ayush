...
export const useContentStore = create(() => ({
  ...
  hero: {
    ...
    heroTitle: "React.js • Node.js • Generative AI • MCP",
    heroImpact: "Shipped AI agents that cut engineering effort by 30%",
    seoDescription: "Ayush Jaiswal is a Full Stack AI Engineer with 6+ years of experience in React.js, Node.js, MongoDB, Express, AI agents, Claude API, and MCP (Model Context Protocol).",
  ...
  about: {
    title: "ABOUT ME",
    subtitle:
      "Passionate about crafting modern, AI-powered web experiences.",
    sections: [
      {
        id: 1,
        heading: "Generative AI & Agents",
        description:
          "I design and ship autonomous AI agents and Generative AI integrations using Claude API, OpenAI API, and MCP to automate real engineering workflows.",
        icons: "/skills/claude.webp",
      },
      {
        id: 2,
        heading: "Full Stack Development",
        description:
          "I build high-performance, scalable web applications end-to-end using React.js, Next.js, Node.js, and modern engineering practices.",
  ...
  skills: {
    ...
    generativeAI: [
      ...
      { id: 33, label: "AI Agents", icon: "/skills/mcp.jpg" },
      { id: 34, label: "LLM Integration", icon: "/skills/claude.webp" },
    ],
    ...
    rotationSkills:[
      ...
      { id: 5, label: "Claude API", icon: "/skills/claude.webp" },
  ...
  experience: [
    {
      ...
      highlightLogo: "/Projects/Adobe/logo.webp",
      role: "Forward Deployed Engineer",
      duration: "Jun 2025 – Present",
      points: [
        "Designed and shipped an autonomous AI agent (Claude API + MCP) that automates end-to-end creative approval and asset-tagging workflows — cutting manual engineering effort by 30%.",
        ...
        "Orchestrated multi-step API workflows in Workfront Fusion cutting asset management overhead by 35% and accelerating release cycles by 20%.",
  ...
  projects: [
    {
      ...
      description:
        "Designed and deployed a production-grade Generative AI platform at PwC (Adobe Client) integrating Firefly API, Photoshop API, Illustrator API, and Workfront Fusion. Built an autonomous AI agent (Claude API + MCP) that automates end-to-end creative approval and asset-tagging workflows, cutting manual engineering effort by 30%. Reduced content production cycles by 40%, cut asset management overhead by 35%, and increased team throughput by 25% through AI-driven workflow automation.",
      tech: [
        "React.js",
        "JavaScript",
        "AI Agents",
      ...
      mainImage: "/Projects/Adobe/main.webp",
      logo: "/Projects/Adobe/logo.webp",
      images: [
        { id: 1, url: "/Projects/Adobe/1.webp" },
        { id: 2, url: "/Projects/Adobe/2.webp" },
        { id: 3, url: "/Projects/Adobe/3.webp" },
        { id: 4, url: "/Projects/Adobe/4.webp" },
        { id: 5, url: "/Projects/Adobe/5.webp" },
        { id: 6, url: "/Projects/Adobe/6.webp" },
        { id: 7, url: "/Projects/Adobe/7.webp" },
      ],
      github: "",
      liveLink: "",
    },

    {
      ...
      mainImage: "/Projects/RedBull/main.webp",
      logo: "/Projects/RedBull/logo.webp",
      images: [
        { id: 1, url: "/Projects/RedBull/1.webp" },
        { id: 2, url: "/Projects/RedBull/2.webp" },
        { id: 3, url: "/Projects/RedBull/3.webp" },
        { id: 5, url: "/Projects/RedBull/5.webp" },
      ],
    ...
    },
    {
      ...
      mainImage: "/Projects/BharatMandapam/main.webp",
      logo: "/Projects/BharatMandapam/logo.webp",
      images: [
        { id: 1, url: "/Projects/BharatMandapam/1.webp" },
        { id: 2, url: "/Projects/BharatMandapam/2.webp" },
        { id: 3, url: "/Projects/BharatMandapam/3.webp" },
        { id: 4, url: "/Projects/BharatMandapam/4.webp" },
        { id: 5, url: "/Projects/BharatMandapam/5.webp" },
      ],
    ...
    },
    {
      ...
      mainImage: "/Projects/iBaseT/main.webp",
      logo: "/Projects/iBaseT/logo.webp",
      images: [
        { id: 1, url: "/Projects/iBaseT/1.webp" },
        { id: 2, url: "/Projects/iBaseT/2.webp" },
        { id: 3, url: "/Projects/iBaseT/3.webp" },
        { id: 4, url: "/Projects/iBaseT/4.webp" },
        { id: 5, url: "/Projects/iBaseT/5.webp" },
        { id: 6, url: "/Projects/iBaseT/6.webp" },
        { id: 7, url: "/Projects/iBaseT/7.webp" },
        { id: 8, url: "/Projects/iBaseT/8.webp" },
        { id: 9, url: "/Projects/iBaseT/9.webp" },
      ],
    },
    {
      id: 5,
      ...
      mainImage: "/Projects/Umang/main.webp",
      logo: "/Projects/Umang/logo.webp",
      images: [
        { id: 1, url: "/Projects/Umang/1.webp" },
        { id: 2, url: "/Projects/Umang/2.webp" },
        { id: 3, url: "/Projects/Umang/3.webp" },
        { id: 4, url: "/Projects/Umang/4.webp" },
        { id: 5, url: "/Projects/Umang/5.webp" },
        { id: 6, url: "/Projects/Umang/6.webp" },
      ],
    ...
    },
    {
      ...
      mainImage: "/Projects/Portfolio/logo.webp",
      logo: "/Projects/Portfolio/logo.webp",
      images: [
        { id: 1, url: "/Projects/Portfolio/1.webp" },
        { id: 2, url: "/Projects/Portfolio/2.webp" },
        { id: 3, url: "/Projects/Portfolio/3.webp" },
        { id: 4, url: "/Projects/Portfolio/4.webp" },
        { id: 5, url: "/Projects/Portfolio/5.webp" },
        { 
          id: 6, url: "/Projects/Portfolio/6.webp"
        }
